...
network_key:
  ...
  default: None
config_path:
  description: "The (absolute) path to the Python OpenZWave configuration files. E.g. '/config/ozw_config'. NOTE: there is also the [update_config service](https://www.home-assistant.io/docs/z-wave/services/) to perform updating the config within python-openzwave automatically."
  required: false
  type: string
